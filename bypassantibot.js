...
//Định cấu hình Puppeteer để sử dụng plugin tàng hình
...
if (process.argv.length !== 6) {
    console.log('Usage: node bypass.js <target> <time> <threads> <proxyfile>');
    process.exit(1);
}
...
async function solveCaptcha(page) {
    ...
    const { data: captchaSolution } = await axios.post('http://2captcha.com/in.php', {
        key: API_KEY,
